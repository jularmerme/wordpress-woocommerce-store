...
if (file_exists('C:/Program Files (x86)/Local/resources/extraResources/local-bootstrap.php')) {
	include_once('C:/Program Files (x86)/Local/resources/extraResources/local-bootstrap.php');
}
$GLOBALS['aiowps_firewall_rules_path'] = __DIR__.'/wp-content/uploads/aios/firewall-rules/';

$GLOBALS['aiowps_firewall_data'] = array(
	'ABSPATH' => 'D:/Repositories/wordpress-woocommerce-store/app/public/',
);
